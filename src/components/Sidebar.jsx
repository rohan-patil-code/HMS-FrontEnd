  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`absolute left-${isExpanded ? "56" : "14"} top-6 bg-blue-700 text-white p-2 rounded-full transition duration-300 hover:bg-blue-800`}
      >
      ...
      {/* Sidebar */}
      <div
        className={`bg-blue-900 text-white h-screen p-5 transition-all duration-500 ease-in-out ${
        ...
        <ul className="mt-10 space-y-4">
          {menuItems.map(({ path, label, icon }) => (
            <li key={path}>
              <NavLink
                to={path}
                className="group flex items-center space-x-3 p-2 rounded transition duration-200 hover:bg-blue-700"
